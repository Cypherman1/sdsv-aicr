...
class ImageMapEditor extends Component {
    ...
    componentDidMount() {
        ...
        this.canvasRef.handler.workareaHandler.setImage('http://107.120.70.222:3000/api/images/197', false, () => {
            ...
            fields.forEach(field => {
                ...
                this.canvasRef.handler.setByObject(object, 'top', area.top + field.position.top)
                this.canvasRef.handler.setByObject(object, 'left', area.left + field.position.left)       
    ...
    canvasHandlers = {
        ...
        onChange: (selectedItem, changedValues, allValues) => {
            ...
            console.log(`onchangeeeee ${changedKey} - ${changedValue}`)
        ...
        onChangeWokarea: (changedKey, changedValue, allValues) => {
            if (changedKey === 'layout') {
                ...
                const { _element, isElement, workareaWidth, workareaHeight } = this.canvasRef.handler.workarea;
                const { canvas } = this.canvasRef.handler;

                console.log("loggggggggggggggg")
                console.log(canvas.getObjects())
                console.log(_element.width)
                console.log(_element.height)
            ...
            if (changedKey === 'width' || changedKey === 'height') {
                console.log("vao onChangeWokarea")
